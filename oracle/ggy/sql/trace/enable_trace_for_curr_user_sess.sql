--#-----------------------------------------------------------------------------------
--# File Name    : enable_trace_for_curr_user_sess.sql
--#
--# Description  : Enable trace for already connected sessions.
--#
--# Call Syntax  : SQL> @enable_trace_for_curr_user_sess.sql (user-name)
--#-----------------------------------------------------------------------------------
...
begin
  ...
  dbms_output.put_line('Enabled trace for below sessions: ');
...
Prompt
Prompt Note: use "disable_trace_for_curr_user_sess.sql" script to disable trace for all user sessions.
Prompt
