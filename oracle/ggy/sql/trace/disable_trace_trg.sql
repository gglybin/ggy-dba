--#-----------------------------------------------------------------------------------
--# File Name    : disable_trace_trg.sql
--#
--# Description  : Disable trace trigger USER_TRACE_TRG.
--#
--# Call Syntax  : SQL> @disable_trace_trg
--#-----------------------------------------------------------------------------------
...
Prompt
Prompt ##
Prompt ## Disabling "USER_TRACE_TRG" trigger:
Prompt ##

alter trigger USER_TRACE_TRG disable;
